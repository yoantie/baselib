...
namespace ULT {
	namespace CONV {
		...
		inline std::wstring UTF8ToUTF16(const char* szSrc)
		{
		...
		inline std::string UTF16ToUTF8(const wchar_t *szSrc)
		{
		...
		*/
		inline std::wstring MBSToUTF16(const char* szSrc)
		{
			wchar_t szBuffer[2048] = { 0 };
		...
		inline std::string UTF16ToMBS(const wchar_t *szSrc)
		{
			char szBuffer[2048] = { 0 };
